...
// which-country-do-you-live-in.html
router.post('/v3/1-check-before-you-start/which-country-do-you-live-in', function (request, response) {
    var country = request.session.data['country']
...
// permanent-care-home.html
router.post('/v3/1-check-before-you-start/permanent-care-home', function (request, response) {
    var careHome = request.session.data['care']
...
// council-help-pay.html
router.post('/v3/1-check-before-you-start/council-help-pay', function (request, response) {
    var council = request.session.data['council']

    if (council == "yes") {
        response.redirect("council-name")
    } else {
        response.redirect("/v3/cannot-apply-online-yet")
    }
});

// council-name.html
router.post('/v3/1-check-before-you-start/council-name', function (request, response) {
    response.redirect("check-your-answers-check-eligibility")
});

// live-with-partner.html
router.post('/v3/1-check-before-you-start/live-with-partner', function (request, response) {
    var livePartner = request.session.data['partner']
...
// who-is-applying.html
router.post('/v3/2-about-you/who-is-applying', function (request, response) {
    var applying = request.session.data['applying']
...
// have-phone-number.html
router.post('/v3/2-about-you/have-phone-number', function (request, response) {
    var phone = request.session.data['phone']
...
// what-is-your-phone-number.html
router.post('/v3/2-about-you/what-is-your-phone-number', function (request, response) {
    response.redirect("have-email-address")
});

// have-email-address.html
router.post('/v3/2-about-you/have-email-address', function (request, response) {
    var email = request.session.data['email']
...
// what-is-your-email-address.html
router.post('/v3/2-about-you/what-is-your-email-address', function (request, response) {
    response.redirect("check-your-answers-contact-details")
});

// who-to-contact.html
router.post('/v3/2-about-you/who-to-contact', function (request, response) {
    var whoContact = request.session.data['whoContact']
...
// they-have-phone-number.html
router.post('/v3/2-about-you/they-have-phone-number', function (request, response) {
    var theyPhone = request.session.data['theyPhone']
...
// what-is-their-phone-number.html
router.post('/v3/2-about-you/what-is-their-phone-number', function (request, response) {
    response.redirect("they-have-email-address")
});

// they-have-email-address.html
router.post('/v3/2-about-you/they-have-email-address', function (request, response) {
    var theyEmail = request.session.data['theyEmail']
...
// what-is-their-email-address.html
router.post('/v3/2-about-you/what-is-their-email-address', function (request, response) {
    response.redirect("check-their-answers-contact-details")
});

// get-a-refund.html
router.post('/v3/16-submit-application/get-a-refund', function (request, response) {
    var refund = request.session.data['refund']
...
// refund-type.html
router.post('/v3/16-submit-application/refund-type', function (request, response) {
    response.redirect("declaration")
});
...
// get-them-a-refund.html
router.post('/v3/16-submit-application/get-them-a-refund', function (request, response) {
    var themRefund = request.session.data['themRefund']
...
// their-refund-type.html
router.post('/v3/16-submit-application/their-refund-type', function (request, response) {
    response.redirect("their-declaration")
});
...
// claimed-asylum-partner.html
router.post('/v3/1-check-before-you-start/claimed-asylum-partner', function (request, response) {
    var asylumPartner = request.session.data['asylumPartner']
...
// you-or-partner-education.html
router.post('/v3/1-check-before-you-start/you-or-partner-education', function (request, response) {
    var education = request.session.data['education']
...
// partner-money-coming-in.html
router.post('/v3/1-check-before-you-start/partner-money-coming-in', function (request, response) {
    var moneyComingIn = request.session.data['partnerMoneyComingIn']
...
// money-coming-in-2.html
router.post('/v3/1-check-before-you-start/money-coming-in-2', function (request, response) {
    var moneyComingIn = request.session.data['moneyComingIn2']
...
// claimed-asylum.html
router.post('/v3/1-check-before-you-start/claimed-asylum', function (request, response) {
    var asylum = request.session.data['asylum']
...
// asylum-application-decision.html
router.post('/v3/1-check-before-you-start/asylum-application-decision', function (request, response) {
    var decision = request.session.data['decision']
...
// support-from-uk-visas-immigration.html
router.post('/v3/1-check-before-you-start/support-from-uk-visas-immigration', function (request, response) {
    var support = request.session.data['support']
...
// education-or-training.html
router.post('/v3/1-check-before-you-start/education-or-training', function (request, response) {
    var training = request.session.data['training']
...
// financial-support.html
router.post('/v3/1-check-before-you-start/financial-support', function (request, response) {
    var financialSupport = request.session.data['financialSupport']
    console.log(financialSupport);
...
// money-coming-in.html
router.post('/v3/1-check-before-you-start/money-coming-in', function (request, response) {
    let moneyComingIn = request.session.data['moneyComingIn'];
    ...
    for (const checkbox of moneyComingIn) {
        if (checkbox === 'cant-apply') {
            return response.redirect('/v3/cannot-apply-online-yet');
        }
    }
...
// more-than-6000.html
router.post('/v3/1-check-before-you-start/more-than-6000', function (request, response) {
    var moreThan6000 = request.session.data['moreThan6000']
...
// more-than-6000-2.html
router.post('/v3/1-check-before-you-start/more-than-6000-2', function (request, response) {
    var moreThan6000 = request.session.data['more-than-6000-2']
...
//term-dates-correct.html
router.post('/v3/4-education-and-training/term-dates-correct', function (request, response) {
    var termDatesCorrect = request.session.data['term-dates-correct']
...
//how-many-terms.html
router.post('/v3/4-education-and-training/how-many-terms', function (request, response) {
    var terms = request.session.data['terms']
...
router.post('/v3/1-check-before-you-start/email-address-continue', function (request, response) {
...
//date-of-birth-continue.html
router.post('/v3/1-check-before-you-start/date-of-birth-continue', function (request, response) {

    response.redirect("code-email")
});

//code-email.html
router.post('/v3/1-check-before-you-start/code-email', function (request, response) {
    const accessCode = request.body['example-email'];

    if (!accessCode || accessCode.trim() === '') {
        return response.render('v3/1-check-before-you-start/code-email', { error: 'empty' });
    }

    if (!/^\d{6}$/.test(accessCode.trim())) {
        // This runs if the code is NOT 6 digits (e.g. empty, too short, too long, contains letters)
        return response.render('v3/1-check-before-you-start/code-email', { error: 'invalid' });
    }

    if (accessCode.trim() !== '123456') {
        return response.render('v3/1-check-before-you-start/code-email', { error: 'incorrect' });
    }
    response.redirect("your-application-progress")
});
...
// how-paying-for-things.html
router.post('/v3/3-about-your-income/how-paying-for-things', function (request, response) {
    let howPayingForThings = request.session.data['howPayingForThings'];
    ...
    // If "None of these" is selected, skip follow-up pages
    if (howPayingForThings.includes("none")) {
        return response.redirect("/v3/3-about-your-income/how-paying-daily-costs");
    }
    ...
    if (howPayingForThings.includes("Money from friends or family")) {
        followUpPages.push("/v3/3-about-your-income/amount-from-friends-relatives");
    }
    if (howPayingForThings.includes("Savings")) {
        followUpPages.push("/v3/3-about-your-income/amount-from-savings");
    }
    if (howPayingForThings.includes("Donations from charity or voluntary organisations")) {
        followUpPages.push("/v3/3-about-your-income/amount-from-donations");
    }
    ...
    if (followUpPages.length > 0) {
        ...
        return response.redirect("/v3/3-about-your-income/check-your-answers-other-income");
    }
});



router.post('/v3/3-about-your-income/amount-from-friends-relatives', function (request, response) {
    request.session.data['friendsAmount'] = request.body.friendsAmount;
    redirectToNextFollowUpPage(request, response);
});

router.post('/v3/3-about-your-income/amount-from-savings', function (request, response) {
    request.session.data['savingsAmount'] = request.body.savingsAmount;
    redirectToNextFollowUpPage(request, response);
});

router.post('/v3/3-about-your-income/amount-from-donations', function (request, response) {
    request.session.data['donationsAmount'] = request.body.donationsAmount;
    redirectToNextFollowUpPage(request, response);
});
...
router.post('/v3/3-about-your-income/how-paying-daily-costs', function (request, response) {
    const dailyCosts = request.body.dailyCosts;
    request.session.data['dailyCosts'] = dailyCosts;

    response.redirect('/v3/3-about-your-income/check-your-answers-other-income');
});


//universal-credit
router.post('/v3/3-about-your-income/universal-credit', function (request, response) {
    var universalCredit = request.session.data['universal-credit']

    if (universalCredit == "yes") {
        response.redirect('/v3/3-about-your-income/universal-credit-claim')
    } else if (universalCredit == "not-yet") {
        response.redirect('/v3/3-about-your-income/awaiting-universal-credit')
    } else {
        response.redirect('')
    }
...
//universal-credit-claim
router.post('/v3/3-about-your-income/universal-credit-claim', function (req, res) {
    res.redirect('/v3/3-about-your-income/universal-credit-take-home-pay')
})
...
// Children (Jan 2026)
router.post('/v3/5-about-your-home/support-children-financially--current', function (req, res) {
    let destination = 'live-with-another-person--current';
    res.redirect(destination);
});

router.post('/v3/5-about-your-home/support-children-financially--simple', function (req, res) {
    let destination = 'live-with-another-person--simple';
    res.redirect(destination);
});
...
router.post(/support-children-financially--full/, function (req, res) {
    ...
    let destination = (hasChildren === 'no' || noOfChildren === 0) ? 'live-with-another-person--full' : 'about-your-children--full';
    if (req.originalUrl.indexOf('full-v3') > -1) {
        destination += '-v3';
    }
...
router.post(/about-your-children--full/, function (req, res) {
    let destination = (req.originalUrl.indexOf('full-v3') > -1) ? 'live-with-another-person--full-v3' : 'live-with-another-person--full';
    res.redirect(destination);
});
...
router.post('/v3/2-about-you/date-of-birth', function (req, res) {
    ...
    res.redirect('/v3/2-about-you/find-your-address')

})

router.post('/v3/2-about-you/find-your-address', function (req, res) {

    const postcode = (req.body.postcode || '').trim()

    if (!postcode) {

        return res.render('v3/2-about-you/find-your-address', {
            errorList: [
                {
...
router.post('/v3/2-about-you/select-your-address', function (req, res) {

    if (!req.body.selectedAddress) {

        return res.render('v3/2-about-you/select-your-address', {
            errorList: [
                {
                    text: 'Select your address',
                    href: '#selectedAddress'
...
router.post('/v3/2-about-you/their-date-of-birth', function (req, res) {

    res.redirect('/v3/2-about-you/find-their-address')

})

router.post('/v3/2-about-you/find-their-address', function (req, res) {

    const postcode = (req.body.postcode || '').trim()

    if (!postcode) {

        return res.render('v3/2-about-you/find-their-address', {
            errorList: [
                {
                    text: 'Enter a postcode',
                    href: '#postcode'
    ...
    res.redirect('/v3/2-about-you/select-their-address')

})

router.post('/v3/2-about-you/select-their-address', function (req, res) {
